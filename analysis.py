...
def calculate_hit_false_alarm_rates(folder_path='/Users/codylejang/Desktop/eyewitness/class_data'):
    ...
    # column to categorize "short" and "long" conditions based on encoding_duration
    ...
    for condition, group in grouped:
        # proportions for SN and NS trials
        ...
        # boundary corrections to avoid Z-scores of infinity
        if p_c_sn == 1:
    ...
    for (participant, condition), group in grouped_participants:
        ...
        # d' and lambda to their respective lists for t-tests
        if condition == 'short':
    ...
    # paired t-tests for participant-level d' and lambda
